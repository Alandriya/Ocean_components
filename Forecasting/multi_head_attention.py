...
class MultiHeadAttention(keras.layers.Layer):
    ...
    def __init__(self, d_model, num_heads, filter_size):
        ...
        self.wq = keras.layers.Conv2D(d_model, filter_size, padding='same', activation='relu')
        self.wk = keras.layers.Conv2D(d_model, filter_size, padding='same', activation='relu')
        self.wv = keras.layers.Conv2D(d_model, filter_size, padding='same', activation='relu')

        self.final_weight = keras.layers.Conv2D(d_model, filter_size, padding='same')
